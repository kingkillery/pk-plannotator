...
gh api repos/kingkillery/pk-plannotator/issues/<number>/comments --jq '.[].user.login'

# Get PR review comments
gh api repos/kingkillery/pk-plannotator/pulls/<number>/comments --jq '.[].user.login'
```
...
8. **Full Changelog link**:
   ```
   **Full Changelog**: https://github.com/kingkillery/pk-plannotator/compare/<prev-tag>...<new-tag>
   ```

...
const GITHUB_API = 'https://api.github.com/repos/kingkillery/pk-plannotator/releases/latest';
      ...
      try {
        ...
        if (previewVersion) {
          ...
          setUpdateInfo({
            ...
            releaseUrl: `https://github.com/kingkillery/pk-plannotator/releases/tag/v${cleanPreview}`,

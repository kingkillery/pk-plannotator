...
Download the paste service binary for your platform from [GitHub Releases](https://github.com/kingkillery/pk-plannotator/releases). Binaries are available for macOS (ARM64, x64), Linux (x64, ARM64), and Windows (x64).
